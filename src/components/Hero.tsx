...
export default function Hero() {
  ...
  // No overflow-hidden on <section> (iOS Safari hairline clip with blur + motion).
  return (
    <section className="relative flex flex-col bg-[#0a0a0c]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden>
        <div className="absolute -top-48 -left-40 h-[min(520px,90vw)] w-[min(520px,90vw)] rounded-full bg-[#6b1420]/45 blur-[100px] md:blur-[140px]" />
        <div className="absolute top-[18%] -left-16 h-[400px] w-[400px] rounded-full bg-brand-red/25 blur-[95px] md:blur-[130px]" />
        <div className="absolute -bottom-36 left-[5%] h-[340px] w-[340px] rounded-full bg-[#4a0f18]/35 blur-[80px] md:blur-[110px]" />
        <div className="absolute -top-32 -right-28 h-[min(500px,85vw)] w-[min(500px,85vw)] rounded-full bg-[#152a4a]/55 blur-[95px] md:blur-[130px]" />
        <div className="absolute top-[30%] -right-10 h-[380px] w-[380px] rounded-full bg-brand-blue-900/35 blur-[90px] md:blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[8%] h-[320px] w-[320px] rounded-full bg-[#1a2d4d]/40 blur-[75px] md:blur-[100px]" />
      </div>
