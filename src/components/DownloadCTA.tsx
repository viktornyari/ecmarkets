...
export default function DownloadCTA() {
  return (
    <section id="download" className="relative min-h-[500px] overflow-hidden">
      <Image
        src="https://images.unsplash.com/photo-1543269865-cbf427effbad?w=1600&q=80&auto=format"
        alt=""
        fill
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="group inline-flex items-center gap-3 rounded-2xl bg-white px-7 py-4 text-black transition-all hover:bg-white/90 hover:-translate-y-1 hover:shadow-xl"
              >
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 px-7 py-4 text-white transition-all hover:bg-white/20 hover:-translate-y-1 hover:shadow-xl"
              >
                <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
